 ...
 * instrument their code by accessing the metric methods.
 * <p>
 * By default, a <i>noop</i> instrumentation class is instantiated - which minimizes
 ...
 * <ol>
 * <li>{@link org.ericace.instrumentation.Instrumentation}           - Defines an interface that a specific
 *                                                                     instrumentation implementation must implement</li>
 * <li>{@link org.ericace.instrumentation.InstrumentationManager}    - Instantiates a NOOP instrumentation class, unless
 *                                                                     a JVM property is defined specifyin a different
 *                                                                     instrumentation implementation class</li>
 * <li>{@link org.ericace.instrumentation.Metric}                    - Defines the operators allowed on an individual
 *                                                                     instrumentation metric</li>
 * <li>{@link org.ericace.instrumentation.MetricType}                - Defines the supported metric types. These are
 *                                                                     strongly influenced by Prometheus</li>
 * <li>{@link org.ericace.instrumentation.NoopInstrumentation}       - Provides a NOOP instrumentation implementation
 *                                                                     to minimize runtime overhead when running
 *                                                                     without instrumentation, while not requiring
 *                                                                     consumers to remove instrumentation code</li>
